    ...
    while True:
        ...
        if output:
            ...
            if "Initialization Sequence Completed" in str(output):
                ...
                print(
                    "[dim pale_turquoise4][+] Connection Detail:[/dim pale_turquoise4]"
                )
                ip, country = get_network_detail()
                print(f"[dim pale_turquoise4][-] VPN IP: {ip}[/dim pale_turquoise4]")
                print(
                    f"[dim pale_turquoise4][-] VPN Country: {country}[/dim pale_turquoise4]\n"
                )
                ...
                try:
                    ...
                    print(
                        "[dim pale_turquoise4][*] ----- VPN session closed ----- [/dim pale_turquoise4]\n"
                    )
                    break
                except Exception as e:
                    print(e)
